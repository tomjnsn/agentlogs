...
function OpenCodeIcon() {
  return (
    <svg width="14" height="18" viewBox="0 0 32 40" fill="#a5b4fc">
...
function OgImage({ data }: { data: TranscriptData }) {
  ...
  return (
    ...
    >
      {/* Top section - source badge, model, repo */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        >
          ...
          {data.messageCount && data.messageCount > 0 && (
            ...
            >
              <MessageIcon />
              <span style={{ fontSize: "18px", color: "#a1a1aa" }}>{data.messageCount} messages</span>
            </div>
          )}
          {/* Line stats */}
          {hasChanges && (
