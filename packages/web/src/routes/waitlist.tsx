...
function WaitlistPage() {
  ...
  if (!session) {
    return (
      <main className="dark mx-auto max-w-4xl scheme-dark">
        <div className="bg-dot-pattern flex min-h-screen flex-col items-center justify-center border-x border-white/10">
  ...
  return (
    <main className="dark mx-auto max-w-4xl scheme-dark">
      <div className="flex min-h-screen flex-col border-x border-white/10">
        ...
        {/* Main content */}
        <section className="bg-dot-pattern flex flex-1 flex-col items-center justify-center px-6 py-24">
        ...
        {/* Footer */}
        <footer className="line-t flex min-h-16 items-center justify-center">
